...
export function Brand({compact=false,to='/app'}:{compact?:boolean;to?:string}){return <Link className="brand brand-link" to={to} aria-label="VolunteerHQ dashboard"><span className="brand-mark">E</span>{!compact&&<span><b>VolunteerHQ</b><small>Go to main dashboard</small></span>}</Link>}
